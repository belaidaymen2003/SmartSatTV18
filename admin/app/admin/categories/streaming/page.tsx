...
export default function StreamingPage() {
  ...
  useEffect(() => { setPage(1); fetchChannels(1); }, [query, categoryFilter]);
          ...
          <div className="space-y-4">
            <div className="flex flex-col sm:flex-row items-start gap-4">
              ...
              <div>
                ...
                <div className="text-xs text-white/60">{preview.category}</div>
            ...
            <div className="flex flex-col sm:flex-row gap-2">
              <a
                ...
                rel="noreferrer"
                className="inline-flex items-center gap-2 px-3 py-2 rounded border border-white/10 text-white/80 hover:bg-white/10"
              >
                <Plus className="w-4 h-4" /> Add Subscription
              </a>
              <button onClick={()=>setPreview(null)} className="px-3 py-2 rounded border border-white/10">Close</button>
            </div>
          </div>
        </ConfirmModal>
      )}
